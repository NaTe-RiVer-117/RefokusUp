    ...
    <div className=" max-w-screen-xl mx-auto py-10 flex gap-32">
      ...
      <div className="basis-1/2 flex gap-4">
        <div className="basis-1/3">
          <h4 className=" mb-10 text-white capitalize font-semibold text-xl">socials</h4>
          {["instagram", "twitter (x?)", "LinkedIn"].map((item, index) => (
            <a key={index} className="block mt-2 capitalize hover:text-white text-zinc-400">{item}</a>
          ))}
        </div>
        <div className="basis-1/3">
          <h4 className=" mb-10 text-white font-semibold capitalize text-xl">Sitemap</h4>
